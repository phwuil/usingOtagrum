...
# structures = os.listdir("../data/samples/gaussian/alarm/r08/")
# structures.sort()
...
size_max = {'asia':15000, 'alarm':10000}
# size_max = {structure:10000 for structure in structures}
n_points = {'asia':10, 'alarm': 2}
...
# cbic_bernstein = Pipeline('cbic', max_parents=4, hc_restart=5,
                          # cmode=cmi.CModeTypes_Bernstein)
