...
for size in sizes:
    ...
    # cpc_time_str = 'size_'+str(size).zfill(3) + '_0*' +'/r08/times/cpc/5_005_f*t*np*r5/*.csv'
    ...
    # cbic_time_str = 'size_'+str(size).zfill(3) + '_0*' +'/r08/times/elidan/4_5_0_f*t*np*r5/*.csv'
    ...
    # gmiic_time_str = 'size_'+str(size).zfill(3) + '_0*' +'/r08/times/cmiic/0_1_f*t*np*r5/*.csv'
    ...
    # bmiic_time_str = 'size_'+str(size).zfill(3) + '_0*' +'/r08/times/cmiic/1_1_f*t*np*r5/*.csv'
...
loglog = True
size = 10000
bmiic_time_mean[size].plot(yerr=bmiic_time_std[size], capsize=4, elinewidth=2.5,
                           # linestyle="-",linewidth=4.25,color="royalblue", label='b-miic',
                           linestyle="-",linewidth=4.25,color="royalblue", label='_nolegend_',
                           ax=ax, loglog=loglog)
gmiic_time_mean[size].plot(yerr=gmiic_time_std[size], capsize=4, elinewidth=2.5,
                           # linestyle="--",linewidth=4.25,color="goldenrod", label='g-miic',
                           linestyle="--",linewidth=4.25,color="goldenrod", label='_nolegend_',
                           ax=ax, loglog=loglog)
cbic_time_mean[size].plot(yerr=cbic_time_std[size], capsize=4, elinewidth=2.5,
                          linestyle=(0, (1,1)),linewidth=4.25,color="olivedrab",
                          label='_nolegend_', ax=ax, loglog=loglog)
                          # label='cbic', ax=ax, loglog=loglog)
cpc_time_mean[size].plot(yerr=cpc_time_std[size], capsize=4, elinewidth=2.5,
                         linestyle="-.",linewidth=4.25,color="maroon", label='_nolegend_',
                         # linestyle="-.",linewidth=4.25,color="maroon", label='cpc',
                         ax=ax, loglog=loglog)
ax.set_xscale('log', basex=2)
ax.set_yscale('log')
ax.set_xlim([sizes[0], sizes[-1]])
# ax.xaxis.set_major_locator(MaxNLocator(5))
ax.set_xticks([2, 8, 32, 64])
for axis in [ax.xaxis]:
    axis.set_major_formatter(ticker.FuncFormatter(myLogFormat))
ax.set_ylim(top=15e3)
handles, labels = ax.get_legend_handles_labels()
handles = [h[0] for h in handles]
ax.legend(handles, labels)

plt.savefig(fig_directory.joinpath(distribution+"/dimensional_complexity_"+distribution+".pdf"),
            transparent=True)
...
bmiic_fscore_mean[size].plot(yerr=bmiic_fscore_std[size], capsize=4, elinewidth=2.5,
                             # linestyle="-",linewidth=4.25,color="royalblue", label='b-miic',
                             linestyle="-",linewidth=4.25,color="royalblue", label='_nolegend_',
                             ax=ax, loglog=loglog)
gmiic_fscore_mean[size].plot(yerr=gmiic_fscore_std[size], capsize=4, elinewidth=2.5,
                             # linestyle="--",linewidth=4.25,color="goldenrod", label='g-miic',
                             linestyle="--",linewidth=4.25,color="goldenrod", label='_nolegend_',
                             ax=ax, loglog=loglog)
cbic_fscore_mean[size].plot(yerr=cbic_fscore_std[size], capsize=4, elinewidth=2.5,
                            linestyle=(0, (1,1)),linewidth=4.25,color="olivedrab",
                            label='cbic', ax=ax, loglog=loglog)
                            # label='_nolegend_', ax=ax, loglog=loglog)
cpc_fscore_mean[size].plot(yerr=cpc_fscore_std[size], capsize=4, elinewidth=2.5, linestyle="-.",
                           linewidth=4.25,color="maroon", label='cpc', ax=ax, loglog=loglog)
                           # linewidth=4.25,color="maroon", label='_nolegend_', ax=ax, loglog=loglog)
ax.set_xlim([sizes[0], sizes[-1]])
handles, labels = ax.get_legend_handles_labels()
handles = [h[0] for h in handles]
ax.legend(handles, labels)

plt.savefig(fig_directory.joinpath(distribution+"/fscore_dimensional_complexity_"+distribution+".pdf"), transparent=True)
...
bmiic_hamming_mean[size].plot(yerr=bmiic_hamming_std[size], capsize=4, elinewidth=2.5,
                              linestyle="-",linewidth=4.25,color="royalblue", label='b-miic',
                              ax=ax, loglog=loglog)
gmiic_hamming_mean[size].plot(yerr=gmiic_hamming_std[size], capsize=4, elinewidth=2.5,
                              linestyle="--",linewidth=4.25,color="goldenrod", label='g-miic',
                              ax=ax, loglog=loglog)
cbic_hamming_mean[size].plot(yerr=cbic_hamming_std[size], capsize=4, elinewidth=2.5,
                             linestyle=(0, (1, 1)),linewidth=4.25,color="olivedrab", label='cbic',
                             ax=ax, loglog=loglog)
cpc_hamming_mean[size].plot(yerr=cpc_hamming_std[size], capsize=4, elinewidth=2.5,
                            linestyle="-.",linewidth=4.25,color="maroon", label='cpc',
                            ax=ax, loglog=loglog)
ax.set_xlim([sizes[0], sizes[-1]])
handles, labels = ax.get_legend_handles_labels()
...
plt.savefig(fig_directory.joinpath(distribution + "/hamming_dimensional_complexity_"+distribution+".pdf"), transparent=True)
